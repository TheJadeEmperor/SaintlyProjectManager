...
$printify = array(
	'add_item' => array (
		'display' => 'Generate section titles ',
		'url' => 'http://localhost/FictionTagsDatabase/titles.php'
	),
	'add_favorite' => array (
		'display' => 'Local Host - Power Force',
		'url' => 'http://localhost/AnimeFanservice.org/contents-for-power-force-fanfiction/'
	),
	'my_orders' => array (
		'display' => 'Local Host - Demon Slayer',
		'url' => 'http://localhost/AnimeFanservice.org/contents-for-demon-slayer-fanfiction/'
	),	
	'my_store' => array (
		'display' => 'Get tags',
		'url' => 'http://localhost/FictionTagsDatabase/dom.php'
	),
);
